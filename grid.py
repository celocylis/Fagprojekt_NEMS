...
#resample the grids
lon_n, lat_n = pr.utils.check_and_wrap(globals()[f'LON{i}'][arctic_ice], globals()[f'LAT{i}'][arctic_ice])
lon_s, lat_s = pr.utils.check_and_wrap(globals()[f'LON{i}'][antarctic_ice], globals()[f'LAT{i}'][antarctic_ice])
...
n_GR = pr.kd_tree.resample_nearest(arctic_def, GR_list,\
